  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-[760px] px-6 pb-24 pt-20 sm:px-10">
        ...
        <header className="mb-4 rounded-3xl border border-border-subtle bg-[rgba(6,6,11,0.55)] p-6 backdrop-blur-[8px] light:bg-white sm:p-8">
          {post.category ? (
        ...
        <div className="rounded-3xl border border-border-subtle bg-[rgba(6,6,11,0.55)] p-8 backdrop-blur-[8px] light:bg-white sm:p-10">
          <div
        ...
        {(prev || next) ? (
          <nav
            ...
            className="mt-10 flex flex-col gap-3 text-sm sm:flex-row sm:items-center sm:justify-between sm:gap-6"
          >
            {prev && prev.type === "blog" ? (
              <Link
                href={`/contents/posts/${prev.slug}`}
                className="group inline-flex max-w-full items-center gap-2 text-text-muted transition-colors hover:text-text"
              >
            ...
            {next && next.type === "blog" ? (
              <Link
                ...
                className="group inline-flex max-w-full items-center gap-2 text-text-muted transition-colors hover:text-text sm:justify-end"
              >
